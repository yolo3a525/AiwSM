...
<form id="item" class="layui-form" action="">
    ...
    <div class="layui-form-item">
 		...
 		<div class="layui-input-inline">
   	 	...
   	 	<br><br>
		<img id="jewelryImage" alt=""  src="" width="200">
        </div>
    </div>
    <div class="layui-form-item">
    	 ...
    	 <br><br>
		 <button id="movieButton" style='display:none' class="layui-btn" type="button" onclick="play();">播放</button>
        </div>
   </div>
    ...
    <div class="layui-form-item">
    	...
    	<button class="layui-btn " lay-submit="" lay-filter="item">新增</button>
    	<button class="layui-btn " lay-submit="" lay-filter="item2">新增后继续添加</button>
    	</div>
    </div>
</form>
...
var addUrl = "<%=basePath%>bdzb/jewelry/save";
...
//保存
function save(again){
	$.post(addUrl,$('#item').serialize(),function(data){
...
//播放
  function play(){ 
	...
	parent.layer.open({
        ...
        ,content: '<div><embed src="<%=basePath%>upload/temp/${tempid}.mp4" type="audio/mpeg" width="544" height="544" ></embed></div>'
