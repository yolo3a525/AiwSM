	...
	<input type="hidden" name="id">
		 <div class="layui-form-item">
    		...
    		<div class="layui-input-inline">
		    	...
		    	<input type="text" name="tenantId"  lay-verify="required" autocomplete="on"  class="layui-input">
	 ...
	 <div class="layui-form-item">
    		...
    		<div class="layui-input-inline">
		    	...
		    	<input type="text" name="method"  lay-verify="required" autocomplete="on"  class="layui-input">
                	
            </div>
     </div>
	 <div class="layui-form-item">
    		<label class="layui-form-label">afterJifen</label>
    		<div class="layui-input-inline">
    	
		    	<input type="text" name="afterJifen"  lay-verify="required|number" autocomplete="on"  class="layui-input">
                	
            </div>
     </div>
	 <div class="layui-form-item">
    		<label class="layui-form-label">jifen</label>
    		<div class="layui-input-inline">
	 ...
	 <div class="layui-form-item">
    		<label class="layui-form-label">consume</label>
    		<div class="layui-input-inline">
    	
		    	<input type="text" name="consume"  lay-verify="required|number" autocomplete="on"  class="layui-input">
...
var addUrl = "<%=basePath%>bdzb/jifen/save";
var updateUrl ="<%=basePath%>bdzb/jifen/update";
