	...
	<input type="hidden" name="id">
		 <div class="layui-form-item">
    		...
    		<div class="layui-input-inline">
		    	...
		    	<input type="text" name="type"  lay-verify="required|number" autocomplete="on"  class="layui-input">
...
var addUrl = "<%=basePath%>bdzb/label/save";
var updateUrl ="<%=basePath%>bdzb/label/update";
