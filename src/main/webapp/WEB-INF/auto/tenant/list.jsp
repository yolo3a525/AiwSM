  ...
  <div class="layui-form-item">
	...
	<div id="page"></div>
		...
		<div class="layui-tab-item">
			<iframe src="<%=basePath%>tenant" id= "add_iframe" height=600 scrolling="no" frameborder="0"></iframe>
		</div>
	</div>
</div>	
...
laypage.render({
 ...
 function del(id){
  ...
  function edit(id){
     ...
     var iframe = '<iframe id ="iframe_eidt_'+id+'" src="<%=basePath%>bdzb/tenant/'+id+'" style="height:' + mainHeight + 'px;width:100%"></iframe>';
