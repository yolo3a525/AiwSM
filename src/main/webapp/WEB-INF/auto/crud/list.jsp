...
<div class="layui-tab layui-tab-brief sub-page-tab" lay-filter="sub_tab">
		...
		<div class="layui-tab-content">
			...
			<div class="layui-tab-item">
				<iframe src="<%=basePath%>crud" id= "add_iframe" height=600 scrolling="no" frameborder="0"></iframe>
			</div>
		</div>
	</div>	
...
laypage.render({
 ...
 function edit(id){
     ...
     var iframe = '<iframe id ="iframe_eidt_'+id+'" src="<%=basePath%>crud/'+id+'" style="height:' + mainHeight + 'px;width:100%"></iframe>';
 ...
 function del(id){
 	var url = "<%=basePath%>crud/delete/"+id;
