			...
			<c:if test="${not empty list}">
				<c:forEach items="${list}" var="a">
					...
					<td>${a.name}</td>
						<td>
							 <div class="layui-progress" lay-showpercent="true">
							    <div class="layui-progress-bar" lay-percent="${a.progress}%"></div>
							  </div>
					...
					<div class="layui-btn-group">
		    			...
		    			<button class="do-action layui-btn layui-btn-small layui-btn-danger" data-type="ajaxDelete" data-url="<%=basePath%>workplan/delete/${a.id}">删除</button>
		  			</div>
...
<div id="page"></div>
			...
			<div class="layui-tab-item">
				<iframe src="<%=basePath%>workplan" id= "add_iframe" height=600 scrolling="no" frameborder="0"></iframe>
			</div>
		</div>
	</div>
...
function edit(id){
    ...
    var iframe = '<iframe id ="iframe_eidt_'+id+'" src="<%=basePath%>workplan/'+id+'" style="height:' + mainHeight + 'px;width:100%"></iframe>';
 ...
 function del(id){
 	var url = "<%=basePath%>workplan/delete/"+id;
