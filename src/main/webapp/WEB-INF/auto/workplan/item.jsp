    ...
    <form id="item" class="layui-form" action="">
         ...
         <div class="layui-form-item">
        		<label class="layui-form-label">progress</label>
        		 <div class="layui-input-inline">
                <input type="text" name="progress"  lay-verify="required" autocomplete="on"  class="layui-input">
                </div>
         </div>
        <div class="layui-form-item">
...
var addUrl = "<%=basePath%>workplan/save";
var updateUrl ="<%=basePath%>workplan/update";
