...
<form class="layui-form "  id="query" action="">
  <div class="layui-form-item">
  	<div class="layui-inline">
	    <label class="layui-form-label">姓名(模糊)</label>
...
<input type="file" name="excel" lay-type="file" class="layui-upload-file"> 
	...
	<div id="page"></div>
		...
		<div class="layui-tab-item">
			<iframe src="<%=basePath%>employee" id= "add_iframe" height=600 scrolling="no" frameborder="0"></iframe>
		</div>
	</div>
</div>	
...
var $ = layui.jquery, form = layui.form
  ...
  layui.upload.render({
     url: '<%=basePath%>employee/readExcel' //上传接口
...
laypage.render({
 ...
 function del(id){
 	var url = "<%=basePath%>employee/delete/"+id;
  ...
  function edit(id){
     ...
     var iframe = '<iframe id ="iframe_eidt_'+id+'" src="<%=basePath%>employee/'+id+'" style="height:' + mainHeight + 'px;width:100%"></iframe>';
