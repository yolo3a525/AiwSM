	...
	<input type="hidden" name="id">
		 <div class="layui-form-item">
    		...
    		<div class="layui-input-inline">
		    	...
		    	<input type="text" name="email"  lay-verify="required" autocomplete="on"  class="layui-input">
	 ...
	 <div class="layui-form-item">
    		...
    		<div class="layui-input-inline">
		    	...
		    	<input type="text" name="phone"  lay-verify="required" autocomplete="on"  class="layui-input">
...
var addUrl = "<%=basePath%>employee/save";
var updateUrl ="<%=basePath%>employee/update";
