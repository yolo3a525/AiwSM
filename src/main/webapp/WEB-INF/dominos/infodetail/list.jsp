  ...
  <div class="layui-form-item">
					...
					<td>${a.createUser }</td> 
						<td>
							...
							<button class="do-action layui-btn layui-btn-small layui-btn-danger" 
											data-type="ajaxDelete" data-url="<%=basePath%>dominos/infodetail/delete/${a.id}">删除</button>
							</div>
						</td>
					</tr>
				</c:forEach>
	...
	<div id="page"></div>
		...
		<div class="layui-tab-item">
			<iframe src="<%=basePath%>dominos/infodetail/badd" id= "add_iframe" height=600 scrolling="no" frameborder="0"></iframe>
		</div>
	</div>
</div>	
...
laypage.render({
 ...
 function del(id){
 	var url = "<%=basePath%>dominos/infodetail/delete/"+id;
  ...
  function edit(id){
     ...
     var iframe = '<iframe id ="iframe_eidt_'+id+'" src="<%=basePath%>dominos/infodetail/bedit/'+id+'" style="height:' + mainHeight + 'px;width:100%"></iframe>';
